#!/usr/bin/python3
"""Defines the FileStorage class for serializing and deserializing objects to a JSON file."""
import json
import os
import datetime
...
class FileStorage:
    ...
    def reload(self):
        """Deserializes objects from the JSON file and loads them into the storage dictionary."""
